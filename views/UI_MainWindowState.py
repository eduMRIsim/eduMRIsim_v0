...
class ScanCompleteState(ExamState):
    ...
    def update_UI(self, context) -> None:
        super().update_UI(context)
        context.scannedImageWidget.scannedImageExportStandardButton.setEnabled(True)
...
class MRIfortheBrainState(UI_MainWindowState):
    def update_UI(self, context) -> None:
        ...
        context.scannedImageWidget.scannedImageExportStandardButton.setEnabled(False)
