    ...
    def export_file_dialog(self, image: AcquiredImage | None) -> None:
        ...
        if file_name:
            if selected_filter == "JPEG Files (*.jpeg)":
                ...
                ExportAcquiredImageDialog.export_to_standard_image_file(
                ...
                ExportAcquiredImageDialog.export_to_dicom_file(
                    image_data_normalized, file_name
                )
                ...
                ExportAcquiredImageDialog.export_to_nifti_file(
                    image_data_normalized, file_name
                )
