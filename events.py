...
class EventEnum(Enum):
    ...
    SCAN_VOLUME_UPDATED = auto() # Event for when the scan volume is updated, i.e., when the scan volume parameters are changed 
    ...
    # Scanlist element events
    SCANLIST_ELEMENT_STATUS_CHANGED = auto() # Event for when the status of a scanlist element is changed, e.g., from 'BEING_MODIFIED' to 'READY_TO_SCAN'